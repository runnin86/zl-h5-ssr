<template>
  <div class="cell_box v-picker">
    ...
    <div class="cell_ft">
      <div style="text-align:left;" @touchstart="showPicker">
        <input :id="'name-box-' + uuid" class="cell_primary" value="请选择" style="border:none;text-align:left;color: #999999; width:100%" @input="getVal" readonly="readonly">
