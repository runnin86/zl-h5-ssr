...
import { once, addClass, removeClass } from './dom.js'
...
<style scoped>
  ...
  .wv-swipe .wv-swipe-wrapper {
    position: relative;
    overflow: hidden;
    height: 100%;
  }
  .wv-swipe .wv-swipe-wrapper div {
    position: absolute;
  ...
  .wv-swipe .wv-swipe-wrapper div.is-active {
    display: block;
    transform: none;
  }

  .wv-swipe .wv-swipe-indicators {
    position: absolute;
    bottom: 10px;
    left: 50%;
    transform: translateX(-50%);
  }
  .wv-swipe .wv-swipe-indicators .wv-swipe-indicator {
  ...
  .wv-swipe .wv-swipe-indicators .wv-swipe-indicator.is-active {
